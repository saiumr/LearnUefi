...
typedef struct GIF_LOGICAL_SCREEN_DESCRIPTOR
{
    ...
    CHAR8 flag_table_size : 3;  // size of global table
    CHAR8 flag_sort : 1;        // sort flag
    CHAR8 flag_cr : 3;          // color resolution
    CHAR8 flag_color_table : 1; // global color table flag
    UINT8 bg_color_index;      // usually 0
    CHAR8 aspect_ratio;         // usually 0
...
typedef struct GIF_GRAPHICS_CONTROL_EXTENSION
{
    ...
    CHAR8 size;                       // 0x04
    CHAR8 flag_transparency_used : 1; // enable/disable transparency, if enable we need set a color key as transparency color
    CHAR8 flag_input : 1;             // user input
    CHAR8 flag_disposal_method : 3;   // 0~3 useful, 4~7 reserved for future
    CHAR8 flag_reserved : 3;          // 000
    UINT16 delay_time;               // 1/100 s
    CHAR8 transparent_color_index;    // transparency color key
    CHAR8 terminator;                 // 0x00
...
typedef struct GIF_IMAGE_DESCRIPTOR
{
    ...
    CHAR8 flag_table_size : 3;  // size of local color table
    CHAR8 flag_reserved : 2;    // 00
    CHAR8 flag_sort : 1;        // sort flag
    CHAR8 flag_interlace : 1;   // Interlace Flag
    CHAR8 flag_color_table : 1; // enable/disable local color table
